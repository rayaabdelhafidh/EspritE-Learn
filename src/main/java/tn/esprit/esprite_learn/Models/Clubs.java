...
public class Clubs {
    ...
    public Clubs(String nomClub, Date dateFondation, String typeActivite, String description, int nbMembres, boolean active) {
        NomClub = nomClub;
        DateFondation = dateFondation;
        TypeActivite = typeActivite;
        Description = description;
    ...
    public boolean equals(Object o) {
        ...
        Clubs clubs = (Clubs) o;
        return Objects.equals(NomClub, clubs.NomClub);
    }

    @Override
    public int hashCode() {
        return Objects.hash(NomClub);
    }
}
